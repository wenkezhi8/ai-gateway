      ...
      <el-col :span="24">
        <el-card shadow="never" class="page-card">
          ...
          <el-alert
            ...
            show-icon
            class="section-alert"
            title="新手先保证向量 Pipeline 能跑通，再考虑冷热分层和后端切换。"
          />
          ...
          <section class="panel-section">
            ...
            <div class="header-actions section-actions">
              <el-button type="primary" :loading="ctx.dualModelSaving" @click="ctx.saveDualModelConfigData">保存配置</el-button>
              <el-button :loading="ctx.ollamaStarting" @click="ctx.startVectorModel">启动模型</el-button>
            </div>
          </section>
          ...
          <section class="panel-section">
                  ...
                  <el-descriptions :column="2" border size="small">
                    ...
                    <el-descriptions-item label="状态">
                      <el-tag :type="ctx.vectorStats.enabled ? 'success' : 'warning'">
                        {{ ctx.vectorStats.message || (ctx.vectorStats.enabled ? '可用' : '未启用') }}
                      </el-tag>
                    </el-descriptions-item>
                  </el-descriptions>
                </el-card>
            ...
            <el-card shadow="never" class="page-card nested-card">
              ...
              <el-form label-position="top" class="compact-form test-form-grid">
                <el-form-item label="测试文本" class="test-query-item">
            ...
            <el-collapse>
              <el-collapse-item name="advanced" title="高级设置">
                ...
                <div class="header-actions section-actions advanced-actions">
                  <el-button type="primary" :loading="ctx.dualModelSaving" @click="ctx.saveDualModelConfigData">保存高级设置</el-button>
                  <el-button :loading="ctx.dualModelSaving" @click="ctx.switchVectorModel">切换模型</el-button>
                </div>
                ...
                <el-card shadow="never" class="page-card nested-card">
                  ...
                  <el-descriptions :column="2" border size="small" class="tier-stats">
