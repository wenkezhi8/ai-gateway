<template>
  <el-form :model="form" label-width="110px" class="import-form">
    ...
    <el-form-item label="PDF 文件名" required>
      <el-input v-model="form.file_name" placeholder="如 docs.pdf" />
    </el-form-item>
    <el-form-item label="文件路径" required>
      <el-input v-model="form.file_path" placeholder="如 /tmp/docs.pdf" />
    </el-form-item>
    <el-form-item label="文件大小" required>
      <el-input-number v-model="form.file_size" :min="1" :step="1024" />
    </el-form-item>
    <el-form-item label="预估记录数" required>
      <el-input-number v-model="form.total_records" :min="1" />
    </el-form-item>
    <el-form-item>
      <el-button type="primary" :loading="submitting" @click="submit">创建 PDF 导入任务</el-button>
    </el-form-item>
  </el-form>
</template>
