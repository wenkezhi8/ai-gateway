<template>
  <el-form :model="form" label-width="110px" class="import-form">
    ...
    <el-form-item label="CSV 文件名" required>
      <el-input v-model="form.file_name" placeholder="如 docs.csv" />
    </el-form-item>
    <el-form-item label="文件路径" required>
      <el-input v-model="form.file_path" placeholder="如 /tmp/docs.csv" />
    </el-form-item>
    ...
    <el-form-item>
      <el-button type="primary" :loading="submitting" @click="submit">创建 CSV 导入任务</el-button>
    </el-form-item>
  </el-form>
</template>
