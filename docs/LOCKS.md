...
| codex | codex | ollama-service-enhancement | codex/ollama-service-enhancement | .worktrees/codex-20260303-0538 | internal/handler/admin/{admin.go,router.go}, internal/config/config.go, internal/constants/routing.go, internal/service/ollama_service.go, internal/service/ollama_service_test.go, web/src/views/ollama/**, web/src/api/routing-domain.ts, scripts/dev-restart.sh, docs/LOCKS.md | RELEASED | 2026-03-03 05:38 | 2026-03-03 06:16 | 与 static-data-api-only-refactor 在 web/src/api/** 共享改动窗口，本分支仅修改 Ollama 相关 API 方法 |
