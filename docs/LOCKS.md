...
| AI-A | codex | vector-kb-ui | ai-a/vector-kb-ui | .worktrees/ai-a-vector-kb-ui | internal/knowledge/**, internal/router/router.go, web/src/api/knowledge*.ts, web/src/store/knowledge*.ts, web/src/views/knowledge/**, web/src/router/index.ts, docs/LOCKS.md | RELEASED | 2026-03-01 11:59 | 2026-03-01 12:09 | 向量知识库管理UI与后端MVP实现 |
